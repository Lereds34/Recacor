...
export const metadata: Metadata = {
  title: "Devis mécanique gratuit — Recacor Le Crès",
  description:
    "Obtenez votre devis vidange, freinage ou parallélisme en 2 minutes. Recacor Le Crès vous rappelle sous 2h. Sans rendez-vous.",
  robots: { index: false, follow: false },
};

export default function FormulaireMecaniquePage() {
  return (
